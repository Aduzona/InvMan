...
tab <- data.frame("ord.material.id(MSE)" = as.character(id.vec[id.ord.mse]), "MSE" = mse.ord, "class.mse" = class.mse, "ord.material.id(MSLA)" = as.character(id.vec[id.ord.msla]) , "ESLAR" = msla.ord, "class.msla" = class.msla )
...
tab <- data.frame("mat.id"=id.ord.msla,  "LAR" = msla.ord, "class.RSU" = class.msla , "cum.rel.val.share" = rel.cum.val.vec.ord[as.character(id.ord.msla)] , "class.ABC" = class.vec[as.character(id.ord.msla)] )

kable(tab, digits = c(0,3,0,2,0), "pandoc", row.names=F)
