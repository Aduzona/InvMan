...
```{r, exe3-1, echo=FALSE}
df <- cbind(0:5, round(dbinom(0:6, 6, prob = 2/3),3), round(pbinom(0:6, 6, prob = 2/3),3) )
...
<!-- stock.perf(res.sim.exp)$alpha -->
<!-- stock.perf(res.sim.app)$alpha -->
<!-- stock.perf(res.sim.pre)$alpha -->
<!-- ``` -->
